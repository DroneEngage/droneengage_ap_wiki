...
**Note:** The authenticator only accepts connections, so it only needs public keys. See [S2S Authentication](de-server-s2s-authentication.md) for complete setup guide.
